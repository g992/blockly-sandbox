...
Blockly.Blocks["bb"] = {
  init: function () {
    ...
    this.appendDummyInput()
      .appendField("line")
      .appendField(new Blockly.FieldDropdown(bollingerDropdown), "line");
    this.appendDummyInput()
      .appendField("price")
      .appendField(new Blockly.FieldDropdown(priceDropdown), "price");
    this.appendDummyInput()
      .appendField("stdDev")
      .appendField(new Blockly.FieldNumber(2, 0, 200), "stdDev");
    this.appendDummyInput()
      .appendField("index")
...
Blockly.JavaScript["bb"] = function (block) {
  ...
  var number_stdDev = block.getFieldValue("stdDev");
  var number_index = block.getFieldValue("index");
  // TODO: Assemble JavaScript into code variable.
  var code = `BB('${dropdown_timeframe}',${number_period},'${dropdown_price}',${number_stdDev},${number_index})['${dropdown_line}']`;
  // TODO: Change ORDER_NONE to the correct strength.
  return [code, Blockly.JavaScript.ORDER_ATOMIC];
};

Blockly.Blocks["bb_simple"] = {
  init: function () {
    this.appendDummyInput()
      .appendField("BB at")
      .appendField(new Blockly.FieldDropdown(timeframeDropdown), "timeframe");
...
Blockly.JavaScript["bb_simple"] = function (block) {
  var dropdown_timeframe = block.getFieldValue("timeframe");
  var number_period = block.getFieldValue("period");
  var dropdown_line = block.getFieldValue("line");
  // TODO: Assemble JavaScript into code variable.
  var code = `BB('${dropdown_timeframe}',${number_period})['${dropdown_line}']`;
  // TODO: Change ORDER_NONE to the correct strength.
  return [code, Blockly.JavaScript.ORDER_ATOMIC];
};
